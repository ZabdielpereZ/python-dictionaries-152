# Adding and Updatingh elements in a dictionary
...
# Merges another dictionary into the existing dictionary, into the existing dictionary, updates keys if necessary
